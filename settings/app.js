	...
	.controller('ThemeSettingsCtrl', ['$scope', '$http', '$location',
		function ($scope, $http, $location) {
			...
			$scope.tinymceOptions =	{
				...
				,content_css: '/themes/' + queryString.themeName + '/versions/' + queryString.themeVersion + '/styles/e8f67d25.main.css' //and this right here folks is why we can't use textAngular
			};
