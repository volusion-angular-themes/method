	...
	.controller('ThemeSettingsCtrl', ['$scope', '$http', '$location',
		function ($scope, $http, $location) {
			...
			$scope.tinymceOptions =	{
				...
				,content_css: '/themes/' + queryString.themeName + '/versions/' + queryString.themeVersion + '/styles/c546c0a9.main.css' //and this right here folks is why we can't use textAngular
			};
